...
<div class="fixed right-4 bottom-4 z-50">
	<Popover bind:open title="Theme Settings" side="top" align="end" sideOffset={16}>
		...
		<div
			class="scrollbar-thin scrollbar-thumb-md-sys-color-outline-variant hover:scrollbar-thumb-md-sys-color-outline flex max-h-[80vh] w-72 flex-col gap-6 overflow-y-auto p-4"
		>
			<!-- Source Color -->
