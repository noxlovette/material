...
export const dialogue = tv({
	slots: {
		base: 'fixed inset-0 z-40 flex items-center justify-center bg-md-sys-color-scrim/32',
		inner:
			'bg-md-sys-color-surface-container-high shadow-elevation-3 flex relative max-w-4xl flex-col rounded-2xl p-6 gap-4',
