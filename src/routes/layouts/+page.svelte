...
<div class="relative min-h-screen">
  ...
  {:else if variant === 'scroll'}
    <div class="flex h-screen w-full items-center justify-center p-12">
      <Card class="flex h-[400px] w-full max-w-lg flex-col overflow-hidden">
        <div class="border-md-sys-color-outline-variant border-b p-4">
        ...
        <div class="border-md-sys-color-outline-variant border-t p-4">
  ...
  <!-- FLOATING TOOLBAR -->
  <div
    class="bg-md-sys-color-surface-container-highest shadow-elevation-3 fixed bottom-8 left-1/2 z-50 -translate-x-1/2 transform rounded-xl"
  >
