  ...
  <Pane rounded={false}>
    <header class="mb-10 flex flex-col gap-3">
      ...
      <Body class="text-md-sys-color-on-surface-variant max-w-2xl">
        A dropdown list of choices that appears on top of app content when triggered. Menu is split
        into two components: <code class="doc-code">Menu</code> (the shell — open state and floating
        panel positioning) and <code class="doc-code">MenuItem</code> (a single interactive row inside
        it).
      </Body>
