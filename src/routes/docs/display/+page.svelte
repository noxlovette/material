    ...
    <SinglePane>
      <header class="mb-10 flex flex-col gap-3">
        ...
        <Body class="text-md-sys-color-on-surface-variant max-w-2xl">
          <code class="doc-code">Display</code> is the largest text in the M3 type scale, reserved
          for short, high-impact text or numerals — hero headlines, splash screens, big stats. It
          renders an <code class="doc-code">&lt;h1&gt;</code>.
        </Body>
      ...
      <section id="overview" class="mb-12 flex flex-col gap-4 scroll-mt-6">
        ...
        <Body>
          ...
          (small/medium/large) and <code class="doc-code">emphasized</code> — and differ only in which
