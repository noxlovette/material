  ...
  <Pane rounded={false}>
    <header class="mb-10 flex flex-col gap-3">
      ...
      <Body class="text-md-sys-color-on-surface-variant max-w-2xl">
        Icon buttons help people take minor actions, often used in app bars and toolbars where space
        is tight. <code class="doc-code">ButtonIcon</code> shares the same emphasis levels as
    ...
    <section id="overview" class="mb-12 flex flex-col gap-4 scroll-mt-6">
      ...
      <Body>
        ...
        <code class="doc-code">variation="toggle"</code> for a two-state icon button (e.g. bookmark,
        mute) — it swaps the underlying element for Bits UI's
