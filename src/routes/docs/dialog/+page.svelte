...
<svelte:head>
  <title>Dialog — Svelte Material Docs</title>
</svelte:head>
  ...
  <Pane rounded={false}>
    ...
    <section id="naming" class="mb-12 flex scroll-mt-6 flex-col gap-4">
      ...
      <Body>
        ...
        — even though this docs page (and the underlying M3 concept) is called "Dialog." This is a
        naming quirk of the library, not a typo:
