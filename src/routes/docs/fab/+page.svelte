...
<svelte:head>
  <title>FAB — Svelte Material Docs</title>
</svelte:head>
...
<PaneGrid direction={{ small: 'column', large: 'row' }} gap="lg" full>
  <Pane rounded={false}>
    ...
    <section id="overview" class="mb-12 flex scroll-mt-6 flex-col gap-4">
      ...
      <Body>
        Set <code class="doc-code">withMenu</code> to turn the FAB into a trigger for a radial menu
        of <code class="doc-code">FABMenuItem</code> actions — clicking the FAB swaps its icon for a
        close icon and opens <code class="doc-code">FABMenu</code>, positioned above it and closed
        automatically on an outside click. Use this pattern instead of a single FAB when there are
        2–5 related primary actions to choose from.
      </Body>
    </section>
