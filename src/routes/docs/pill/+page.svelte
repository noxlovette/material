  ...
  <Pane rounded={false}>
    <header class="mb-10 flex flex-col gap-3">
      ...
      <Body class="text-md-sys-color-on-surface-variant max-w-2xl">
        A small rounded label for a short piece of static text — a status word, a count, a category
    ...
    <section id="overview" class="mb-12 flex scroll-mt-6 flex-col gap-4">
      ...
      <Body>
        ...
        shares the filled-button color classes for its system-color variants (so it always matches
        the active theme), plus two fixed accent colors (<code class="doc-code">yellow</code>
