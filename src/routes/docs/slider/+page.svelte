...
<svelte:head>
  <title>Slider — Svelte Material Docs</title>
</svelte:head>
  ...
  <Pane rounded={false}>
    ...
    <section id="overview" class="mb-12 flex scroll-mt-6 flex-col gap-4">
      ...
      <Body>
        ...
        >
        pattern, including the M3-specific gapped track (a visible break between the active fill and the
        handle).
      </Body>
      <Body>
        Set a numeric <code class="doc-code">step</code> and <code class="doc-code">stops</code>
        to render discrete tick marks; leave <code class="doc-code">step="any"</code> for continuous dragging.
      </Body>
    </section>
